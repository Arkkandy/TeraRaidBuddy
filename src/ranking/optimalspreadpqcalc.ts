...
*/
export default function getOptimalDefensiveSpread_PQ( gen: Generation, raidBoss: Pokemon, raidDefender: Pokemon,
    moves: Move[], field: Field, useGivenNature: boolean, parameters: RankingParameters) : EVSpread {
    ...
    // Re-enable Quark Drive / Protosynthesis
